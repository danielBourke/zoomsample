...
import { MODAL_OPEN } from "../../app/constants";
    ...
    const dispatch = useDispatch()
      return (
       ...
       {/*         <Tooltip title="create event">
                ...
                <IconButton   onClick={()=>  dispatch({type: MODAL_OPEN})}    style={{
            ...
            {open &&   ( <MeetingForm/>)}
                ...
                >
                  <Avatar style={{                  boxShadow: "0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23)",
